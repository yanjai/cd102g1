...
<body>
	...
	switch ($_FILES['fileImg']['error']) {
		case 0:
    		...
    		$officialImg = $_FILES['fileImg']['name'];
    		$officialName = $_REQUEST["officialName"];
		    $officialPrice = $_REQUEST["officialPrice"];
		    $officialStatus = $_REQUEST["officialStatus"];

			$sql2 = "INSERT INTO officialimglist(officialImgNo,officialImgName,officialImgLName,officialImgPrice,officialImgStatus)values(null,'$officialImg','$officialName','$officialPrice','$officialStatus')";
