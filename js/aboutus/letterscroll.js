{
    class Entry {
        constructor(el) {
            this.DOM = {el: el};
            this.DOM.image = this.DOM.el.querySelector('.abLetterImg');
            this.DOM.title = {word: this.DOM.el.querySelector('.abLetterText')};
    ...
    let current = -1;
    let allentries = [];
    const sections = Array.from(document.querySelectorAll('.abLetterSection'));
    // Preload all the images in the page..
	imagesLoaded(document.querySelectorAll('.abLetterImg'), () => {
