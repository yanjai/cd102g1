{
    ...
    class coSlide {
        constructor(el) {
            ...
            this.DOM.imgWrap = this.DOM.el.querySelector('.coSlideImgWrap');
            // The image element.
            this.DOM.img = this.DOM.imgWrap.querySelector('.coSlideImg');
            // The texts: the parent wrap, title, number and side text.
            this.DOM.texts = {
                wrap: this.DOM.el.querySelector('.coSlideTitleWrap'),
                title: this.DOM.el.querySelector('.coSlideTitle'),
                number: this.DOM.el.querySelector('.coSlideNum'),
                side: this.DOM.el.querySelector('.coSlideSide'),
            };
        ...
        setLeft(isContentOpen) {
            ...
            this.isLeft = true;
            this.DOM.el.classList.add('coSlide--visible');
    ...
    class coContent {
        constructor(el) {
            this.DOM = {el: el};
            this.DOM.number = this.DOM.el.querySelector('.coContentNum');
            this.DOM.title = this.DOM.el.querySelector('.coContentTitle');
            this.DOM.subtitle = this.DOM.el.querySelector('.coContentSub');
            this.DOM.text = this.DOM.el.querySelector('.coContentText');
            this.DOM.backCtrl = this.DOM.el.parentNode.querySelector('.coContentClose');
            this.DOM.backCtrl.addEventListener('click', () => slideshow.hideContent());
        }
        show() {
            this.DOM.el.classList.add('coContentItem--current');
        ...
        hide() {
            this.DOM.el.classList.remove('coContentItem--current');
    ...
    class coSlideshow {
        constructor(el) {
            ...
            // The slides.
            this.slides = [];
            Array.from(this.DOM.el.querySelectorAll('.coSlide')).forEach(slideEl => this.slides.push(new coSlide(slideEl)));
            ...
            this.current = 0;
            this.DOM.deco = this.DOM.el.querySelector('.coSlideshowDeco');

            this.contents = [];
            Array.from(document.querySelectorAll('.coContent > .coContentItem')).forEach(contentEl => this.contents.push(new coContent(contentEl)));
        ...
        showContent() {
            ...
            this.DOM.el.classList.add('coSlideshowPreviewopen');
        ...
        hideContent() {
            ...
            this.DOM.el.classList.remove('coSlideshowPreviewopen');
    ...
    imagesLoaded(document.querySelectorAll('.coSlideImg'), {background: true}, () => document.body.classList.remove('loading'));
}
